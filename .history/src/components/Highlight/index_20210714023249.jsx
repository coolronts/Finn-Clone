...
const Highlight = () => {
 ...
 const styles = {
  ...
  adTitle: " text-black",
  pictureAdContainer: "grid grid-rows-2 grid-flow-col gap-4 cursor-pointer py-5 ",
  adImage: "w-10 rounded mr-2",
  adInfo:"flex flex-col justify-between text-xs mr-12",
