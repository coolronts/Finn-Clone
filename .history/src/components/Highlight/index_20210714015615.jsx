...
const Highlight = () => {
 ...
 const styles = {
  ...
  adTitle: " text-black",
  pictureAdContainer: "cursor-pointer flex py-5 h-full border-b-2 border-transparent hover:border-blue-300",
   ...
   <div className={styles.rightContainer}>
    <div className={styles.adBox}>
     ...
     <div className={styles.pictureAdContainer}>
      {ads.map(ad =>
       <div class="grid grid-rows-2 grid-flow-col gap-4 text-black text-xs h-10 w-1/2">
