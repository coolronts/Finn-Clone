...
const Highlight = () => {
 ...
 const styles = {
  ...
  adTitle: " text-black",
  pictureAdContainer: "grid grid-rows-2 grid-flow-col gap-12 cursor-pointer flex py-5 w-full border-b-2 border-transparent hover:border-blue-300",
  adImage: "w-10 rounded mr-1",
  adInfo:"flex flex-col justify-between",
   ...
   <div className={styles.rightContainer}>
    <div className={styles.adBox}>
     ...
     <div className={styles.pictureAdContainer}>
      {ads.map(ad =>
       <div class=" text-black text-xs h-10 w-1/2">
