...
const Highlight = () => {
 ...
 const styles = {
  ...
  adTitle: " text-black",
  pictureAdContainer: "grid grid-rows-2 grid-flow-col gap-6 cursor-pointer  py-5 ",
  adImage: "w-10 rounded mr-1",
  adInfo:"flex flex-col justify-between text-xs",
  subTitle: "text-gray-40",
 }
 return (
      ...
      {ads.map(ad =>
       <div class=" text-black text-xs h-10 flex ">
        ...
        <div className={styles.adInfo}>
         <p> {ad.adName} </p>
         <p className={styles.adSubtitle}>{ad.subTitle}  </p>
        </div>
       </div>
       )}
