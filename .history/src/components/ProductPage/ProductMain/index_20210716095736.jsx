...
const ProductMain = () => {
  return (
      ...
      <div className="mt-24 px-36 flex justify-between h-full pb-12">
        ...
        <p className="font-semibold text-medium">Inkluderer <span className="text-base font-medium">Strøm, Bredbånd, Vannbåren Gulvvarme, Balansert Ventilasjon, Internett</span></p>
