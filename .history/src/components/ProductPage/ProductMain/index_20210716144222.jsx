  ...
  return (
      ...
      <div className={styles.main}>
        ...
        <div>
          ...
          <LoadScript googleMapsApiKey="AIzaSyC6doKmnshrEDCjGAuyURuIMDQpBWTRzn8" className="shadow-sm ring-2">
            <GoogleMap
          ...
          <div className="bg-blue-100 mt-6 rounded-lg p-6">
            ...
            <div className="flex mt-6">
              <Swiper spaceBetween={20} slidesPerView={3} navigation={true} pagination={{ clickable: true }} className="swiper-navigation-black">
                <SwiperSlide >
                    <SmallCard />
                </SwiperSlide>
                <SwiperSlide>
