...
const ProductMain = () => {
  ...
  function swiperAreaInfo() {
    var swiperArea = new Swiper("#tours.swiper-container", {
      slidesPerView: 3,
      navigation: {
  ...
  return (
      ...
      <div className={styles.main}>
        ...
        <div>
          ...
          <div className="flex">
            <Swiper pagination={{"type": "fraction"}} navigation={true} className="swiper-navigation-blue">
              <SwiperSlide className="w-2/5 mx-3">
                  <SmallCard />
              </SwiperSlide>
              <SwiperSlide className="w-2/5 mx-3">
                  <SmallCard />
