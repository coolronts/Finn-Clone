      ...
      <div className="mt-24 px-36 flex justify-between h-full">
        <div className="h-2/3 w-3/5">
          ...
          <div className="flex mt-4">
            <button className="bg-white font-medium hover:bg-transparent border-2 hover:border-blue-700 text-blue-700 text-xl rounded-md py-3 px-4">Legg till favourit</button>
          </div>
        </div>
