  ...
  return (
      ...
      <div className="mt-24 px-36 flex justify-between h-full">
        <div className="h-2/3 w-3/5">
          ...
          <button className="bg-white font-medium hover:bg-transparent border-2 hover:border-blue-700 text-blue-700 text-lg font-semibold rounded-md py-1 px-4">
            <AiOutlineHeart className="inline text-3xl"/>Legg till favourit
          </button>
          </div>
        </div>
