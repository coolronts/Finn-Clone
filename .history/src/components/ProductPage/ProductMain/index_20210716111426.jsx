...
const ProductMain = () => {
  const styles = {
    ...
    option:"font-semibold text-medium"
  ...
  return (
      ...
      <div className={styles.main}>
        ...
        <div className={styles.options}>
          <p >Inkluderer <span className=" font-medium">Strøm, Bredbånd, Vannbåren Gulvvarme, Balansert Ventilasjon, Internett</span></p>
          <p className={styles.options}>Depositum <span className=" font-medium">37800</span></p>
          <p className={styles.options}>Primærrom <span className=" font-medium">38 m²</span></p>
          <p className={styles.options}>Soverom <span className=" font-medium">1</span></p>
          <p className={styles.options}>Etasje <span className=" font-medium">0</span></p>
          <p className={styles.options}>Boligtype <span className=" font-medium">Hybel</span></p>
          <p className={styles.options}>Leieperiode <span className=" font-medium">01.08.2021</span></p>
