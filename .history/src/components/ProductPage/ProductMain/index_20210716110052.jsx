...
const ProductMain = () => {
  return (
      ...
      <div className="mt-24 px-36 flex justify-between h-full pb-12">
        <div className="h-2/3 w-3/5">
          ...
          <div className="flex mt-4">
            <button className="bg-white hover:bg-blue-50 border-2 hover:border-blue-700 text-blue-700 text-lg font-medium rounded-lg py-1 px-4">
        ...
        <p className="text-xs mt-1 font-lighter">8 har lagt til som favoritt</p>
        <p className="tracking-tight text-3xl mt-4 font-medium">Nyere 2-roms hybel på Ekeberg - Toppstandard</p>
        <p className="text-sm mt-2">Vardeveien 3C, 1182 Oslo</p>
        <p className="tracking-tight text-base mt-2 font-medium">Månedsleie</p>
        ...
        <p className="font-semibold text-medium">Depositum <span className=" font-medium">Strøm, Bredbånd, Vannbåren Gulvvarme, Balansert Ventilasjon, Internett</span></p>
        <p className="font-semibold text-medium">Primærrom <span className=" font-medium">Strøm, Bredbånd, Vannbåren Gulvvarme, Balansert Ventilasjon, Internett</span></p>
        <p className="font-semibold text-medium">Soverom <span className=" font-medium">Strøm, Bredbånd, Vannbåren Gulvvarme, Balansert Ventilasjon, Internett</span></p>
        <p className="font-semibold text-medium">Etasje <span className=" font-medium">Strøm, Bredbånd, Vannbåren Gulvvarme, Balansert Ventilasjon, Internett</span></p>
        <p className="font-semibold text-medium">Boligtype <span className=" font-medium">Strøm, Bredbånd, Vannbåren Gulvvarme, Balansert Ventilasjon, Internett</span></p>
        <p className="font-semibold text-medium">Leieperiode <span className=" font-medium">Strøm, Bredbånd, Vannbåren Gulvvarme, Balansert Ventilasjon, Internett</span></p>
        <p className="font-semibold text-medium">Energimerking <span className=" font-medium">Strøm, Bredbånd, Vannbåren Gulvvarme, Balansert Ventilasjon, Internett</span></p>
