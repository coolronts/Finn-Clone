  ...
  return (
      ...
      <div className={styles.main}>
        ...
        <div className={styles.options}>
          ...
          <p>Depositum <span className=" font-medium">37800</span></p>
          <p>Primærrom <span className=" font-medium">38 m²</span></p>
          <p>Soverom <span className=" font-medium">1</span></p>
          <p>Etasje <span className=" font-medium">0</span></p>
          <p>Boligtype <span className=" font-medium">Hybel</span></p>
          <p>Leieperiode <span className=" font-medium">01.08.2021</span></p>
          <p>Energimerking <span className=" font-medium p-1 bg-yellow-200">A - gul</span></p>
        </div>
