...
const ProductMain = () => {
  ...
  return (
      ...
      <div className={styles.main}>
        ...
        <div className="shadow-sm ring-2"> 
          ...
          <div className="bg-blue-100 mt-6 rounded-sm p-6">
            ...
            <div className="flex mt-6">
              <Swiper direction={'horizontal'} mousewheel={true} scrollbar={{ draggable: true }} spaceBetween={20} slidesPerView={3} navigation={true} pagination={{ clickable: true }} onSwiper={(swiper) => console.log(swiper)} className="swiper-navigation-black">
                <SwiperSlide >
                    <SmallCard />
                </SwiperSlide>
                <SwiperSlide>
