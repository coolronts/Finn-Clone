...
const ProductMain = () => {
  return (
      ...
      <div className="mt-24 px-36 flex justify-between h-full pb-12">
        ...
        <p className="text-lg mt-6">Massivt furubord, beiset i grått og 8 stoler selges. Mål på bord er 250 cm, 88 cm bredt og 7 cm tykkelse. Stolene er pent brukt uten flekker.</p>
        </div>
