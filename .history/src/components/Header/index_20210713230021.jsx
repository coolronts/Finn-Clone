...
const Header = () => {
 const styles = {
  nav: "backdrop-filter backdrop-blur flex justify-between px-36 text-white",
  logoContainer: "flex",
  logo: "w-32",
  logoName: "text-xs self-center",
  menuContainer: "flex bg-blue-700 h-full w-full self-center text-xs",
  li: "flex ml-6 h-full hover:bg-red-300",
  icon: "text-3xl",
