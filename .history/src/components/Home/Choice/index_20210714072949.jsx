...
const Choice = () => {
 const styles={
  ...
  iconText: "text-sm",
  logInAd: "w-full pl-12 py-12",
  logInBody: "bg-blue-50 rounded-md shadow-sm py-4 px-10 w-full h-full flex flex-col justify-evenly items-center",
  loginTitle: "text-md font-semibold",
  loginSubtitle: "text-md text-center",
  button:"bg-blue-600 text-center w-40 px-2 py-3 rounded text-white"
 }
 return (
