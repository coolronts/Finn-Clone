...
const Choice = () => {
 const styles={
  ...
  logInBody: "bg-blue-50 rounded-md shadow-sm p-4 w-full h-full flex flex-col justify-evenly items-center",
  loginTitle: "text-lg font-semibold",
  loginSubtitle: "text-lg"
 }
 return (
