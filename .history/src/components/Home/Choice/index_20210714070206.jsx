 ...
 return (
  <div className={styles.main}>
   <div className={styles.optionsList}>
    ...
    <div className={styles.option}><FaBriefcase className={styles.icon}/><p className={styles.iconText}>Okonomi</p> </div>
    <div className={styles.option}><FaPiggyBank className={styles.icon}/><p className={styles.iconText}>Moteplassen</p> </div>
    <div className={styles.option}><FaHeartbeat className="w-full text-red-500"/><p className={styles.iconText}>Nettbil</p> </div>
   </div>
