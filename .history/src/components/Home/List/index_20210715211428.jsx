   ...
   <div className=" flex flex-wrap py-16" >
    {
     items.slice(0,sliceUpperLimit).map((item, index) =>
      <div className="w-80 py-6" key={item.sys.id}>
        <Card isOpenModal={isOpenModal} place={item.fields.place} title={item.fields.title} id={item.fields.id} image={item.fields.image} />
