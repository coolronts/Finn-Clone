      ...
      <div className="mt-24 px-36 flex justify-between h-auto">
        ...
        <div className="w-full ml-24 sticky">
          ...
          <div className="bg-green-100 w-full flex items-center px-3 py-4 rounded-lg">
            ...
            <div className="ml-2 w-4/5 text-left font-medium  text-black rounded-lg py-3 text-lg">Denne varren sparer CO2 tils varende production av <p>95nye plastposer</p> </div>
