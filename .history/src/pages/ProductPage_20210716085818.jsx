    ...
    <div className="bg-white h-full">
      ...
      <div className="mt-24 px-36 flex justify-between h-auto">
        ...
        <div className="w-1/4 sticky">
          ...
          <div className="bg-green-300 w-full flex items-center px-2 rounded-lg">
            <FaLeaf className="text-3xl text-green-600"/>
            <div className="ml-2 w-3/4 text-left font-medium  text-black rounded-lg py-3 text-lg">Denne varren sparer CO2 tilsvarende production av 95nye plastposer</div>
            <IoIosArrowDown/>
          </div>
