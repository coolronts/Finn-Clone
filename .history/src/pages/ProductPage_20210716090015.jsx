    ...
    <div className="bg-white h-full">
      ...
      <div className="mt-24 px-36 flex justify-between h-auto">
        ...
        <div className="w-1/4 sticky">
          ...
          <button className="bg-blue-600 w-full my-6 font-semibold  hover:bg-blue-800 text-white rounded-lg py-3 text-lg">Send Melding</button>
          
          <div className="bg-green-300 w-full flex items-center px-3 py-4 rounded-lg">
            <FaLeaf className="text-3xl text-green-600"/>
            <div className="ml-2 w-4/5 text-left font-medium  text-black rounded-lg py-3 text-lg">Denne varren sparer CO2 tilsvarende production av 95nye plastposer</div>
            <IoIosArrowDown className="text-blue-300 text-2xl"/>
          </div>
