    ...
    <div className="bg-white h-full">
      ...
      <div className="mt-24 px-36 flex justify-between h-auto">
        ...
        <div className="w-1/4 sticky">
          ...
          <button className="bg-blue-600 w-full mt-2 mb-1 font-semibold  hover:bg-blue-800 text-white rounded-lg py-3 text-lg">Send Melding</button>
          <p className="text-blue-600 text-xs mb-12">Vis mobilnummer</p>
