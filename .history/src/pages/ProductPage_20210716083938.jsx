    ...
    <div className="bg-white h-full">
      ...
      <div className="mt-24 px-36 flex justify-between h-auto">
        ...
        <div className="w-full">
          ...
          <button className="bg-blue-700 w-full mt-3  font-medium hover:bg-transparent border-2 hover:border-blue-700 text-blue-700 text-xs rounded-md p-1">Logg Inn</button>
