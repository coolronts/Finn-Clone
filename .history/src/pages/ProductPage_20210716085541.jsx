      ...
      <div className="mt-24 px-36 flex justify-between h-auto">
        ...
        <div className="w-1/4 sticky">
          ...
          <div className="bg-green-300 w-full flex items-center px-2">
            ...
            <div className="ml-1 w-2/3 font-medium text-center text-black rounded-lg py-3 text-md">Denne varren sparer CO2 tilsvarende production av 95nye plastposer</div>
