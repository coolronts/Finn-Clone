    ...
    <div className="bg-white h-full">
      ...
      <div className="mt-24 px-36 flex justify-between h-auto">
        ...
        <div className="w-1/4 sticky">
          ...
          <div className="w-1/2 bg-green-300 w-full font-medium text-center text-black rounded-lg py-3 text-lg">Denne varren sparer CO2 tilsvarende production av 95nye plastposer</div>
