 ...
 return (
  <div className="relative mt-20  px-36">
   <div className="w-full h-16 bg-white py-2 px-3 shadow-xl rounded-lg flex justify-around ">
    <div>
     <input className="text-2xl font-lighter px-2 border-2 border-gray-200 outline-none w-4/5 rounded-lg" type="search" placeholder="Sok etter IPhone eller fjordhest" />
