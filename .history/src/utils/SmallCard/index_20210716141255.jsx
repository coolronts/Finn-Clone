...
const SmallCard = ({ detail, allImages}) => {
  ...
  const styles = {
    main: "shadow-lg cursor-pointer flex flex-col bg-white rounded-lg w-full h-auto hover:bg-white py-2 px-4  ",
  ...
  return (
    <div class={styles.main}>
      <p className="font-semibold text-sm text-gray-500">Kort gangavstand til offentlig transport</p>
      ...
      <p className="text-blue-600 font-semibold mt-2 text-sm">Mer om transport</p>
      <div>
        <BiBus className="text-7xl text-yellow-300 float-right"/>
      </div>
