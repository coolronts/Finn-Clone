...
const SmallCard = ({ detail, allImages}) => {
  ...
  const styles = {
    main: "shadow-sm cursor-pointer flex flex-col bg-white rounded-lg w-full h-auto hover:bg-white p-2  ",
  ...
  return (
    ...
    <div className="font-base">Kort gangavstand til offentlig transport</div>
