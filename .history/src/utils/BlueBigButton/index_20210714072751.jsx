...
const BigBlueButton = () => {
 return (
  <button className="relative mt-20  px-36">
   <div className="w-full h-20 bg-white py-2 px-3 shadow-xl rounded-lg flex justify-around ">
    <div className="w-4/5 relative self-center">
     <input className="text-2xl font-lighter px-2 py-1 border-2 border-gray-200 outline-none w-full rounded-lg" type="search" placeholder="Sok etter IPhone eller fjordhest" />
