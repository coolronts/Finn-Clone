...
const Modal = () => {
  return (
    <div className="h-screen w-screen bg-transparent flex justify-center items-center fixed top-0 bottom-0 left-0 right-0z-50">
      <div className="w-1/4  p-4 shadow justify-center items-center flex flex-col rounded-md">
        ...
        <div>
          <button className="bg-blue-600 hover:bg-blue-700 text-center font-semibold  px-2 py-3 rounded-lg mt-3  text-white"> Logg Inn</button>
