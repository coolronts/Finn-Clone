...
const Card = ({ detail, allImages}) => {
 ...
 const styles = {
  main: "shadow-sm cursor-pointer flex flex-col bg-white rounded-lg w-full h-full hover:bg-blue-50 p-2  ",
  imageContainer:"relative h-full  w-full",
  image:"object-fit rounded-lg",
 ...
 return (
  <div class={styles.main}>
   <div className={styles.imageContainer}>
    ...
    <img src={mainPictureLink} alt="" className={styles.image}/>
