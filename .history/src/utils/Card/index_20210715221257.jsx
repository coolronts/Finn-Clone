 ...
 useEffect(() => {
  ...
  if (foundImage) {
   ...
   if (mainPictureDetail) {
    mainPictureLink = mainPictureDetail.url
   }
  }
  console.log(mainPictureLink)
  images.ctfassets.net/d7b3k59by6fq/6q4pePDK1wkaNCoR06CxEz/aa2f8a835c8701d726eea0cb70228648/main.jpg
 })
 ...
 return (
  <div class={styles.main}>
   <div className={styles.imageContainer}>
    <img src= "http://"  { mainPictureLink} alt="" className={styles.image}/>
