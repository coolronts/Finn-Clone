 ...
 useEffect(() => {
  ...
  if (foundImage) {
   ...
   if (mainPictureDetail) {
    mainPictureLink = "https:" + mainPictureDetail.url
   }
  }
 ...
 return (
  <div class={styles.main}>
   <div className={styles.imageContainer}>
    <img src="https://images.ctfassets.net/d7b3k59by6fq/7DQGaYEujaeSmFliexoCRH/79e77dcef930fcdea913515a16eafd88/ca37efe1-e630-4712-94b2-d7e99062d539.jpg" alt="" className={styles.image}/>
