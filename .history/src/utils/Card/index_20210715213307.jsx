...
const Card = ({ detail, allImages}) => {
 ...
 useEffect(() => {
  ...
  const foundImage = allImages.find(image => image.fields.sys.id == pictureId)
  const mainPictureLink = foundImage.fields.file.url
 ...
 return (
  <div class={styles.main}>
   <div className={styles.imageContainer}>
    <img src="https://picsum.photos/id/237/800/1000" alt="" className={styles.image}/>
