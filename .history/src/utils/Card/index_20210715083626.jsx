...
const Card = ({ id, title, price }) => {
 const styles = {
  ...
  icon: " absolute top-2 right-2 bg-gray-500 text-white text-3xl hover:opacity-100  ",
  iconContainer:"absolute top-2 right-2 text-white text-3xl rounded-full p-1 w-10 h-10 hover:opacity-50 hover:bg-gray-50",
