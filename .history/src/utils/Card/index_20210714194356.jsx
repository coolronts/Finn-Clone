...
const Card = ({id, title, price,image}) => {
 const styles = {
  main: "cursor-pointer flex flex-col justify-between bg-white rounded-lg w-full h-full mb-12 hover:bg-blue-50 p-2  ",
 ...
 return (
  ...
  <div class={styles.main}>
   <div className={styles.imageContainer}>
    <img src="https://picsum.photos/800/1200"  alt="" className="object-fit rounded-lg"/>
