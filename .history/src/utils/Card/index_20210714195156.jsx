...
const Card = ({id, title, price,image}) => {
 const styles = {
  main: "shadow-lg cursor-pointer flex flex-col bg-white rounded-lg w-full h-full mb-12 hover:bg-blue-50 p-2  ",
 ...
 return (
  ...
  <div class={styles.main}>
   <div className={styles.imageContainer}>
    <img src="https://picsum.photos/800/1000"  alt="" className="object-cover rounded-lg"/>
    <HiOutlineHeart className={styles.icon} />
    <p className={styles.price}>{price} Kr</p>
   </div>
   <h3 class=" text-gray-600 text-sm  mt-24 ">{title }</h3>
  </div>
 )
}
