 ...
 return (
  <div class={styles.main}>
   <div className={styles.imageContainer}>
    ...
    <div className={styles.iconContainer} onClick={()=>setIsModal("asdadadasdad")} />
   
    <HiOutlineHeart onClick={()=>setIsModal("asdadadasdad")}  className={styles.icon} />
   ...
   <p className="text-lg font-semibold">Dog {isModal} </p>
  </div>
 )
}
