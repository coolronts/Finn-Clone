...
const Card = ({id, title, price,image}) => {
 const styles = {
  main: "cursor-pointer relative bg-white  rounded-lg w-full h-full hover:bg-blue-50  ",
  icon:"absolute top-0 right-0 text-gray-500 text-3xl",
 ...
 return (
  ...
  <div class={styles.main}>
     ...
     <img src="https://picsum.photos/1600/1200"  alt=""class="rounded-lg relative overflow-hidden"/>
