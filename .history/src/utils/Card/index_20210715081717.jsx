 ...
 return (
  <div class={styles.main}>
   <div className={styles.imageContainer}>
    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTBbNOzjFHbeH2n0RFnkZVj9joXViUpwlfC9Q&usqp=CAU"  alt="" className="object-cover rounded-lg"/>
    <HiOutlineHeart className={styles.icon} />
    <p className={styles.price}>{price} Kr</p>
   </div>
   <div className="flex justify-between mt-16">
    <h3 class=" text-gray-600 text-xs ">Fajna</h3>
