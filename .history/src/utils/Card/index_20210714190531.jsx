...
const Card = ({id, title, price,image}) => {
 const styles = {
  main: "cursor-pointer flex justify-between relative bg-white rounded-lg w-full h-full hover:bg-blue-50 p-2  ",
 ...
 return (
  ...
  <div class={styles.main}>
   ...
   <div class="-mt-10">
    <h3 class=" text-gray-600 text-lg my-2 uppercase">{title }</h3>
