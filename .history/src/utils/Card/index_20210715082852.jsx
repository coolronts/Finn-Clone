...
const Card = ({ id, title, price }) => {
 const styles = {
  ...
  icon: "absolute top-2 right-3 text-white text-3xl rounded-full p-1 w-8 h-8 hover:bg-gray-50",
  iconContainer:"absolute top-2 right-3 text-white text-3xl rounded-full p-1 w-8 h-8 hover:bg-gray-50",
